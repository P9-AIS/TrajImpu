...
if __name__ == "__main__":
    ...
    heatmapCfg = cfg.heatmapGeneratorCfg
    heatmapCfg.color_map = "gray"
    ...
    upload_handler.upload_image(image_path_3034, "bw_depth_heatmap_3034", cfg.depthForceProviderCfg.area)
    upload_handler.upload_image(image_path_3857, "bw_depth_heatmap_3857", new_area)
